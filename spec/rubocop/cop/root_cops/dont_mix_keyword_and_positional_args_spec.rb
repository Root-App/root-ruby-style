...
RSpec.describe RuboCop::Cop::RootCops::DontMixKeywordAndPositionalArgs do
  ...
  it "reports an offense when using positional and keyword args" do
  ...
  it "reports an offense when using optional positional and optional keyword args" do
    expect_offense(<<~RUBY.strip_indent)
  ...
  it "reports an offense when using rest positional and rest keyword args" do
    expect_offense(<<~RUBY.strip_indent)
